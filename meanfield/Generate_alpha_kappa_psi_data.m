...
[psi, k_trans, k_max, diff_mat, err_mat] =alpha_kappa_vs_psi(...
    alpha_p_list, kappa_list, lattice_dims, delta, mu, opts);

alpha_kappa_psi_data = struct('psi',psi,'alpha_list',alpha_p_list,...
    'kappa_list',kappa_list,'mu',mu,'delta',delta,'k_trans',k_trans);
