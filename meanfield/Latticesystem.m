     ...
     function obj = Latticesystem(para)
        ...
        function [mx my] = MakeHardAdjacencyMatrices(obj)
            ...
            for ii = 1:(obj.nSites)
             ...
             mx=sparse(mx(:,1),mx(:,2),mx(:,3),obj.nSites,obj.nSites);
             my=sparse(my(:,1),my(:,2),my(:,3),obj.nSites,obj.nSites);
%                  mx=mx+mx';
%                  my=my+my';
        end %Make A matrix
            ...
            incr = 1;
             for ii = 1:(obj.nSites)
               for jj = 1:(obj.nSites)
                  ...
                  phase = obj.tangle(1)+...
                    2*pi*obj.alpha*obj.sitePositions(ii,2)*obj.A(1)*...
                        (1 - obj.latticeDim(1));
            ...
            incr = 1;
             for ii = 1:(obj.nSites)
               for jj = 1:(obj.nSites)
                  ...
                  shiftii = mod(obj.sitePositions(ii,1)+ydx,...
                      obj.latticeDim(1));

                  if (obj.sitePositions(jj,1) == ...
                         shiftii)
...
%                         obj.sitePositions(ii,1)*(obj.latticeDim(2)));      
                   ...
                   phase = obj.tangle(1)+...
                    2*pi*obj.alpha*(obj.sitePositions(ii,1)*obj.A(2)*...
                        (1 - obj.latticeDim(2)) -ydx*obj.latticeDim(2));   
